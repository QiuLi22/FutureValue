...
namespace FutureValue
{
    public partial class frmFutureValue : Form
    {
        ...
        private void txtFutureValue_MouseHover(object sender, EventArgs e)
        {
            txtMonthlyInvestment.ForeColor = Color.Red;
        }

        //Qiu Li 4/26/2022 Excercise 6-2
